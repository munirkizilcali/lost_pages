...
lendings = Lending.create([
  ...
  {copy_id: 2, borrower_id: 3, status: "active", lend_date: "2018-05-01", due_date: "2018-08-01"},
  ...
  {copy_id: 7, borrower_id: 1, status: "active", lend_date: "2018-05-01" , due_date: "2018-07-01"},
  ...
  {copy_id: 12, borrower_id: 3, status: "active", lend_date: "2018-06-01" , due_date: "2018-08-01"},
  {copy_id: 13, borrower_id: 4, status: "active", lend_date: "2018-05-01" , due_date: "2018-08-01"},
  {copy_id: 14, borrower_id: 5, status: "returned", rating: 5},
  {copy_id: 15, borrower_id: 1, status: "requested"},
  {copy_id: 16, borrower_id: 1, status: "returned", rating: 5},
  {copy_id: 14, borrower_id: 1, status: "returned", rating: 2},
  {copy_id: 16, borrower_id: 1, status: "requested"},
  {copy_id: 16, borrower_id: 2, status: "returned", rating: 1},
  {copy_id: 17, borrower_id: 1, status: "active", lend_date: "2018-07-01" , due_date: "2018-09-01"},
  {copy_id: 18, borrower_id: 2, status: "requested"},
  {copy_id: 19, borrower_id: 3, status: "active", lend_date: "2018-05-01" , due_date: "2018-10-01"},
